...
export const GALLERY: GalleryTemplate[] = [
    {
        ...
        build: () => [
            ...
            kpi('crowdsec', 'attacks_blocked', 'Ataques bloqueados', { x: 0, y: 7, w: 3, h: 4 }, {}, 2),
            kpi('mainwp', 'malware_found', 'Malware detectado', { x: 3, y: 7, w: 3, h: 4 }, {}, 2),
            kpi('mainwp', 'vulnerabilities_count', 'Vulnerabilidades', { x: 6, y: 7, w: 3, h: 4 }, {}, 2),
            ...
            table('crowdsec', 'attack_types', 'Tipos de ataque', { x: 0, y: 18, w: 6, h: 7 }, {}, 2),
    ...
    {
        key: 'crowdsec',
        name: 'CrowdSec (ataques bloqueados)',
        description: 'Defensa de red colaborativa: alertas, ataques e IPs bloqueadas, tipos de ataque y mapa de países de origen.',
        build: () => [
            header('Defensa contra ataques'),
            shield({ x: 0, y: 2, w: 6, h: 5 }, 0, 'Tu sitio, defendido'),
            kpi('crowdsec', 'attacks_blocked', 'Ataques bloqueados', { x: 6, y: 2, w: 3, h: 5 }),
            kpi('crowdsec', 'unique_ips', 'IPs atacantes', { x: 9, y: 2, w: 3, h: 5 }),
            kpi('crowdsec', 'alerts', 'Alertas', { x: 0, y: 7, w: 4, h: 4 }),
            kpi('crowdsec', 'events', 'Eventos maliciosos', { x: 4, y: 7, w: 4, h: 4 }, { format: 'compact' }),
            healthscore({ x: 8, y: 7, w: 4, h: 7 }),
            table('crowdsec', 'attack_types', 'Tipos de ataque', { x: 0, y: 11, w: 4, h: 7 }),
            geo('crowdsec', 'attacks_by_country', 'Origen de los ataques', { x: 4, y: 11, w: 4, h: 7 }),
            table('crowdsec', 'top_attacker_ips', 'IPs más activas', { x: 8, y: 14, w: 4, h: 4 }),
