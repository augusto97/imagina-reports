...
export const GALLERY: GalleryTemplate[] = [
    ...
    {
        key: 'trueranker',
        name: 'Keywords y posiciones (TrueRanker)',
        description: 'Seguimiento de posiciones: posición media, keywords en top 3/10/100, las que subieron o bajaron, evolución diaria y tus keywords destacadas.',
        build: () => [
            header('Posicionamiento de tus keywords'),
            kpi('trueranker', 'avg_position', 'Posición media', { x: 0, y: 2, w: 3, h: 4 }),
            kpi('trueranker', 'keywords_tracked', 'Keywords monitorizadas', { x: 3, y: 2, w: 3, h: 4 }),
            kpi('trueranker', 'top10', 'En top 10', { x: 6, y: 2, w: 3, h: 4 }),
            kpi('trueranker', 'improved', 'Keywords que subieron', { x: 9, y: 2, w: 3, h: 4 }),
            chart('trueranker', 'avg_position_by_date', 'area', 'Posición media por día', { x: 0, y: 6, w: 8, h: 7 }),
            donut('trueranker', 'rank_distribution', 'Distribución de posiciones', { x: 8, y: 6, w: 4, h: 7 }),
            table('trueranker', 'top_keywords', 'Keywords destacadas (por volumen)', { x: 0, y: 13, w: 8, h: 8 }),
            kpi('trueranker', 'top3', 'En top 3', { x: 8, y: 13, w: 4, h: 4 }),
            kpi('trueranker', 'top100', 'En top 100', { x: 8, y: 17, w: 4, h: 4 }),
            kpi('trueranker', 'declined', 'Keywords que bajaron', { x: 0, y: 21, w: 4, h: 4 }),
            kpi('trueranker', 'total_volume', 'Volumen de búsqueda', { x: 4, y: 21, w: 4, h: 4 }, { format: 'compact' }),
            summary({ x: 0, y: 25, w: 12, h: 4 }),
            comments({ x: 0, y: 29, w: 12, h: 4 }),
            cta(33),
        ],
    },
    {
        key: 'google_ads',
        name: 'Google Ads',
        description: 'Rendimiento de tus campañas de Google Ads: inversión, clics, impresiones, conversiones, CTR y CPC, con la evolución diaria y las campañas principales.',
        build: () => [
            header('Tus campañas de Google Ads'),
            kpi('google_ads', 'cost', 'Inversión', { x: 0, y: 2, w: 3, h: 4 }, { format: 'currency' }),
            kpi('google_ads', 'clicks', 'Clics', { x: 3, y: 2, w: 3, h: 4 }),
            kpi('google_ads', 'conversions', 'Conversiones', { x: 6, y: 2, w: 3, h: 4 }),
            kpi('google_ads', 'avg_cpc', 'CPC medio', { x: 9, y: 2, w: 3, h: 4 }, { format: 'currency' }),
            chart('google_ads', 'clicks_by_date', 'area', 'Clics por día', { x: 0, y: 6, w: 8, h: 7 }),
            kpi('google_ads', 'impressions', 'Impresiones', { x: 8, y: 6, w: 4, h: 3 }, { format: 'compact' }),
            kpi('google_ads', 'ctr', 'CTR', { x: 8, y: 9, w: 4, h: 4 }, { format: 'percent' }),
            table('google_ads', 'top_campaigns', 'Campañas principales', { x: 0, y: 13, w: 7, h: 8 }, { bars: false }),
            chart('google_ads', 'impressions_by_date', 'bar', 'Impresiones por día', { x: 7, y: 13, w: 5, h: 8 }),
            summary({ x: 0, y: 21, w: 12, h: 4 }),
            comments({ x: 0, y: 25, w: 12, h: 4 }),
            cta(29),
        ],
    },
    {
        ...
        description: 'Rendimiento de tus campañas de Meta (Facebook e Instagram): inversión, alcance, clics, conversiones, CTR y CPC, con la evolución diaria y las campañas principales.',
        build: () => [
            header('Tus campañas de Meta Ads'),
            kpi('facebook_ads', 'spend', 'Inversión', { x: 0, y: 2, w: 3, h: 4 }, { format: 'currency' }),
            kpi('facebook_ads', 'reach', 'Alcance', { x: 3, y: 2, w: 3, h: 4 }, { format: 'compact' }),
            kpi('facebook_ads', 'clicks', 'Clics', { x: 6, y: 2, w: 3, h: 4 }),
            kpi('facebook_ads', 'conversions', 'Conversiones', { x: 9, y: 2, w: 3, h: 4 }),
            chart('facebook_ads', 'spend_by_date', 'area', 'Inversión por día', { x: 0, y: 6, w: 8, h: 7 }, { format: 'currency' }),
            kpi('facebook_ads', 'impressions', 'Impresiones', { x: 8, y: 6, w: 4, h: 3 }, { format: 'compact' }),
            kpi('facebook_ads', 'ctr', 'CTR', { x: 8, y: 9, w: 4, h: 4 }, { format: 'percent' }),
            table('facebook_ads', 'top_campaigns', 'Campañas principales', { x: 0, y: 13, w: 7, h: 8 }),
            chart('facebook_ads', 'clicks_by_date', 'bar', 'Clics por día', { x: 7, y: 13, w: 5, h: 8 }),
            summary({ x: 0, y: 21, w: 12, h: 4 }),
            comments({ x: 0, y: 25, w: 12, h: 4 }),
            cta(29),
        ],
    },
    {
        key: 'tiktok_ads',
        name: 'TikTok Ads',
        description: 'Rendimiento de tus campañas de TikTok: inversión, impresiones, clics, conversiones, CTR y CPC, con la evolución diaria y las campañas principales.',
        build: () => [
            header('Tus campañas de TikTok'),
            kpi('tiktok_ads', 'spend', 'Inversión', { x: 0, y: 2, w: 3, h: 4 }, { format: 'currency' }),
            kpi('tiktok_ads', 'impressions', 'Impresiones', { x: 3, y: 2, w: 3, h: 4 }, { format: 'compact' }),
            kpi('tiktok_ads', 'clicks', 'Clics', { x: 6, y: 2, w: 3, h: 4 }),
            kpi('tiktok_ads', 'conversions', 'Conversiones', { x: 9, y: 2, w: 3, h: 4 }),
            chart('tiktok_ads', 'spend_by_date', 'area', 'Inversión por día', { x: 0, y: 6, w: 8, h: 7 }, { format: 'currency' }),
            kpi('tiktok_ads', 'ctr', 'CTR', { x: 8, y: 6, w: 4, h: 3 }, { format: 'percent' }),
            kpi('tiktok_ads', 'cpc', 'CPC', { x: 8, y: 9, w: 4, h: 4 }, { format: 'currency' }),
            table('tiktok_ads', 'top_campaigns', 'Campañas principales', { x: 0, y: 13, w: 7, h: 8 }),
            chart('tiktok_ads', 'clicks_by_date', 'bar', 'Clics por día', { x: 7, y: 13, w: 5, h: 8 }),
            summary({ x: 0, y: 21, w: 12, h: 4 }),
            comments({ x: 0, y: 25, w: 12, h: 4 }),
            cta(29),
        ],
    },
    {
        ...
        description: 'Resultados de tus campañas de email: enviados, aperturas, clics, tasas de apertura y clic, bajas y las campañas del periodo.',
        build: () => [
            header('Tu email marketing este mes'),
            kpi('mailchimp', 'campaigns_sent', 'Campañas enviadas', { x: 0, y: 2, w: 3, h: 4 }),
            kpi('mailchimp', 'emails_sent', 'Emails enviados', { x: 3, y: 2, w: 3, h: 4 }, { format: 'compact' }),
            kpi('mailchimp', 'open_rate', 'Tasa de apertura', { x: 6, y: 2, w: 3, h: 4 }, { format: 'percent' }),
            kpi('mailchimp', 'click_rate', 'Tasa de clics', { x: 9, y: 2, w: 3, h: 4 }, { format: 'percent' }),
            kpi('mailchimp', 'opens', 'Aperturas únicas', { x: 0, y: 6, w: 3, h: 4 }),
            kpi('mailchimp', 'clicks', 'Clics', { x: 3, y: 6, w: 3, h: 4 }),
            kpi('mailchimp', 'unsubscribes', 'Bajas', { x: 6, y: 6, w: 3, h: 4 }),
            summary({ x: 0, y: 10, w: 12, h: 4 }),
            table('mailchimp', 'top_campaigns', 'Campañas del periodo', { x: 0, y: 14, w: 12, h: 8 }),
            comments({ x: 0, y: 22, w: 12, h: 4 }),
            cta(26),
        ],
    },
    {
        key: 'ppc_ads',
        name: 'Publicidad (Google + Meta)',
        description: 'Visión cross-canal de toda tu publicidad de pago: inversión y resultados de Google Ads y Meta lado a lado, con ROAS combinado (si tienes ventas conectadas) y las campañas de cada plataforma.',
        build: () => [
            header('Tu publicidad este mes'),
            ...
            kpi('google_ads', 'clicks', 'Clics (Google)', { x: 3, y: 8, w: 3, h: 4 }),
            chart('google_ads', 'clicks_by_date', 'area', 'Clics/día (Google)', { x: 0, y: 12, w: 6, h: 6 }),
            table('google_ads', 'top_campaigns', 'Campañas Google', { x: 0, y: 18, w: 6, h: 7 }),
            // Meta column.
            spec({ type: 'header', props: { title: 'Meta Ads', subtitle: '' }, layout: { x: 6, y: 6, w: 6, h: 2 } }),
            kpi('facebook_ads', 'spend', 'Inversión (Meta)', { x: 6, y: 8, w: 3, h: 4 }, { format: 'currency' }),
            kpi('facebook_ads', 'clicks', 'Clics (Meta)', { x: 9, y: 8, w: 3, h: 4 }),
            chart('facebook_ads', 'spend_by_date', 'area', 'Inversión/día (Meta)', { x: 6, y: 12, w: 6, h: 6 }, { format: 'currency' }),
            table('facebook_ads', 'top_campaigns', 'Campañas Meta', { x: 6, y: 18, w: 6, h: 7 }),
            summary({ x: 0, y: 25, w: 12, h: 4 }),
            advisory({ x: 0, y: 29, w: 12, h: 5 }),
            comments({ x: 0, y: 34, w: 12, h: 4 }),
            cta(38),
        ],
    },
    {
    ...
    },
    {
        ...
        description: 'Estado real de los respaldos más el historial de actualizaciones aplicadas (registro propio del agente, desde su instalación) y la salud del WordPress: versiones, plugins y almacenamiento.',
        build: () => [
            header('Estado de tu sitio'),
            kpi('site_agent', 'updates_applied', 'Actualizaciones aplicadas', { x: 0, y: 2, w: 3, h: 4 }, { format: 'number' }),
            kpi('site_agent', 'updates_pending', 'Pendientes', { x: 3, y: 2, w: 3, h: 4 }, { format: 'number' }),
            kpi('site_agent', 'last_backup_days', 'Días desde el último respaldo', { x: 6, y: 2, w: 3, h: 4 }, { format: 'number' }),
            kpi('site_agent', 'backups_count', 'Respaldos del periodo', { x: 9, y: 2, w: 3, h: 4 }, { format: 'number' }),
            summary({ x: 0, y: 6, w: 12, h: 4 }),
            table('site_agent', 'updates_log', 'Cada actualización aplicada (con fecha y versión)', { x: 0, y: 10, w: 12, h: 8 }),
            table('site_agent', 'backup_status', 'Estado de respaldos', { x: 0, y: 18, w: 6, h: 8 }),
            table('site_agent', 'recent_backups', 'Respaldos recientes', { x: 6, y: 18, w: 6, h: 8 }),
            table('site_agent', 'site_health', 'Salud del sitio', { x: 0, y: 26, w: 6, h: 8 }),
            kpi('site_agent', 'plugins_active', 'Plugins activos', { x: 6, y: 26, w: 3, h: 4 }, { format: 'number' }),
            kpi('site_agent', 'plugins_total', 'Plugins instalados', { x: 9, y: 26, w: 3, h: 4 }, { format: 'number' }),
            kpi('site_agent', 'db_size_mb', 'Base de datos (MB)', { x: 6, y: 30, w: 3, h: 4 }, { format: 'number' }),
            kpi('site_agent', 'uploads_size_mb', 'Archivos subidos (MB)', { x: 9, y: 30, w: 3, h: 4 }, { format: 'number' }),
            comments({ x: 0, y: 34, w: 12, h: 4 }),
            cta(38),
        ],
    },
