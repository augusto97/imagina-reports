...
export const BLOCK_META: Record<BlockType, { label: string; icon: LucideIcon }> = {
    ...
    funnel: { label: 'Embudo', icon: Filter },
    geo_map: { label: 'Geografía', icon: MapPin },
    narrative: { label: 'Texto', icon: Type },
    advisory: { label: 'Diagnóstico IA', icon: Lightbulb },
...
const GROUPS: { title: string; types: BlockType[] }[] = [
    ...
    { title: 'Texto & marca', types: ['header', 'narrative', 'advisory', 'cta', 'image'] },
