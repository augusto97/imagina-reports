...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Imagina Reports — versioned REST API (`/api/v1`). Auth: Laravel Sanctum '
            .'(cookie sessions for the first-party SPAs, API tokens for integrations). Tenant is '
            .'resolved from the authenticated user (CLAUDE.md §8). Public report endpoints use a signed token.',
    ],

    'ui' => [
        'title' => 'Imagina Reports API',
    ],
